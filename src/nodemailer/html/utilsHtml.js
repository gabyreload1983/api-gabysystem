export const getHtmlCloseOrder = (nrocompro) => {
  return `
      <p>Nos comunicamos de Sinapsis SRL para informarte que tu orden de reparación nro ${nrocompro} esta lista para retirar.</p>
      <p>Para mas información, registrate en nuestra pagina y podras acceder al detalle de cada reparación.</p>
